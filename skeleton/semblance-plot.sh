...
grd2cpt -Cseis -I -Z $grdfile > cpt
    ...
    grdview $grdfile -R$R -J$J -O -K -Ccpt -Ba0.5:"":/a0.5:"":WSen -Qs >>$psfile
...
# Skala:
    ...
    grdview cumul.grd -R$R -J$J -O -K -X7.5 -Y-8. -Ccumul.cpt -Ba0.5:"":/a0.5:"":WSen -Qs >>$psfile
