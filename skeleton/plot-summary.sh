...
psbasemap $R -J$J -B1:"":/1:""::."Semblance - Time Map":WSen -O -K -Y7 -X-12.5 >> $psfile
awk '{print $1,$2}' /home/ehlert/.seiscomp3/platebound.gmt | psxy $R -J$J -W1p/0 -A -M  -K -O >> $psfile
sw=0
...
echo $endname 
#scp $endname web_tsunami@141.89.112.130:/Webpage/arbeitsgruppen/geophysik_seismologie/forschung/ruptrack/img/new

scp $endname web_tsunami@141.89.111.29:/Webpage2010/tl_files/arbeitsgruppen/ag_array_seismologie/ruptrack/img/new
